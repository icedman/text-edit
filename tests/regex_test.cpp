...
int main(int argc, char **argv) {

  {
    ...
    Regex::MatchResult res = regex.match(str.c_str(), strlen((char*)str.c_str()), data);
...

  {
    ...
    do {
      ...
      printf(">%d %ld %ld\n", res.type, offset + res.start_offset, offset + res.end_offset);
      std::u16string _w = str.substr(offset + res.start_offset, (res.end_offset - res.start_offset));
